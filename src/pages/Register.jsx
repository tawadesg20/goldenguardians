...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#faedcd] py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <motion.div 
          ...
          transition={{ duration: 0.6 }}
        >
          <h1 className="text-4xl font-bold text-[#58391B] mb-4">Welcome to Golden Guardians</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <motion.div 
            className="bg-white rounded-lg shadow-md p-8 text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
